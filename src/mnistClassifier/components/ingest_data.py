...
import sys
from mnistClassifier.utils.utils import download_file,extract_zip
from mnistClassifier.entity.entity_config import DataIngestionConfig
...
class IngestData:
    ...
    def download_data(self):
        try:
            download_file(self.config.data_url,self.config.download_data_path)
